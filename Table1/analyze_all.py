...
EVALS_DIR     = os.path.expanduser("~/mft-analyses/Table1/evaluations")
OUTPUT_CSV    = os.path.expanduser("~/mft-analyses/Table1/results.csv")
...
for mpath in mapping_files:
    ...
    for opath in ordering_files:
        ...
        out = os.path.join(EVALS_DIR, f"{mbase}_{obase}.txt")
        done += 1
