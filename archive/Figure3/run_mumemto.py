...
data_folder = '/home/Users/rdd4/mft-analyses/Figure3/data_alpha_0.005'
    ...
    if os.path.isdir(parent_path):
        ...
        for sub in os.listdir(parent_path):
            ...
            if os.path.isdir(sub_path):
                ...
                output_path = os.path.join(parent_path, f'{sub}.mums')
                if not os.path.exists(output_path):
                    run_mumemto(sub_path, k=2, l=min_l, output=out_destination)
                    # print(f"Would run: mumemto {os.path.join(sub_path, '*.fasta')} -k 2 -l {min_l} -o {out_destination}")