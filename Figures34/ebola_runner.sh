...
BASE=/dodo/rdd4/mft-data/genomes/final_experiments/ebola
PARSNP=/home/Users/ab235/parsnp_edits/parsnp_external_mums/parsnp

# New output directory
RESULTS=/dodo/ab235/actual-final/ebola

THREADS=16

# Ebola does not appear to have *_cov MUM files, so only run these.
TESTS=(
  nucleotide
  mft_w11
  mft_w5
