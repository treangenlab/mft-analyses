...
BASE=/dodo/rdd4/mft-data/genomes/final_experiments/measles
PARSNP=/home/Users/ab235/parsnp_edits/parsnp_external_mums/parsnp

# New output directory
RESULTS=/dodo/ab235/actual-final/measles
...
echo "============================================================"
echo "All measles Parsnp runs finished"
echo "============================================================"
echo
...
{
  echo "measles Parsnp external-MUM summary"
  echo "ANI filtering skipped with --skip-ani-filter"
  echo "Generated: $(date)"
  echo
