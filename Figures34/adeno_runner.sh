...
BASE=/dodo/rdd4/mft-data/genomes/final_experiments/adenovirus
PARSNP=/home/Users/ab235/parsnp_edits/parsnp_external_mums/parsnp

# New output directory
RESULTS=/dodo/ab235/actual-final/adenovirus
...
echo "============================================================"
echo "All adenovirus Parsnp runs finished"
echo "============================================================"
echo
...
{
  echo "adenovirus Parsnp external-MUM summary"
  echo "ANI filtering skipped with --skip-ani-filter"
  echo "Generated: $(date)"
  echo
